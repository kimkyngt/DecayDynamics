...
fig1 = plot(fracs[2:end], tauDratio_list[2:end], xlab="Excitation fraction (3D1/3P0)", ylab="τfit/τ_i", legend=true, ylims=(0.58, 1), size=(400, 300),lab="i=3D1")
plot!(fracs[2:end], tauPratio_list[2:end], lab="i=3P1")
