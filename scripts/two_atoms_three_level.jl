...
include("../src/Base.jl")
include("../src/many_atoms_three_level.jl")
...
description="m=$(Int(m_exc))_FullyExcitedState_r12=$(round.(positions[1]-positions[2], digits=2))"
...
parameters = @dict F_i g_i Γ_i Bfield positions ρ_0 tspan m_exc knorm
